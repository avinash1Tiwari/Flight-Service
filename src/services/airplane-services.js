...
async function DestroyAirplane(id){
    try{
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND)
        {
            throw new AppError("The airplane you want to delete is not present OR deleted already",error.statusCode)
        }
        throw new AppError("Can not fetch the data of all airplanes ",StatusCodes.INTERNAL_SERVER_ERROR)
...
async function UpdateAirplane(id,data){
    try{
        ...
        if(error.statusCode == StatusCodes.NOT_FOUND)
        {
            throw new AppError("The airplane you want to update is not present OR deleted already",error.statusCode)
        }
        throw new AppError("Can not update the data of  airplane ",StatusCodes.INTERNAL_SERVER_ERROR)
